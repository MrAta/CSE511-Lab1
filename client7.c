...
char *hello[] = {"INSERT Aman J", "DELETE Aman", "PUT Aman Jain", "DELETE Leslie",
	"GET Leslie", "GET Aman", "PUT Leslie Lamp", "INSERT Leslie Lamport", "INSERT Test Case", "DELETE Test" };//{"GET Atajoon", "GET Clifton", "GET Tammy", "INSERT Sami Pali", "DELETE Tammy", "GET Tammy"};
