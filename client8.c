...
char *hello[] = { "INSERT Aman J", "DELETE Aman", "PUT Aman Jain", "DELETE Leslie",
                  "GET Leslie", "GET Aman", "PUT Leslie Lamp", "INSERT Leslie Lamport",
                  "INSERT Test Case",
                  "DELETE Test" };//{"GET Atajoon", "GET Clifton", "GET Tammy", "INSERT Sami Pali", "DELETE Tammy", "GET Tammy"};
char *requests[] = { "INSERT", "GET", "PUT", "DELETE" };
char *keysvals[] = { "Sush", "Aman", "Leslie", "Quinn", "Timmy", "Jordan", "Hummels", "Sami", "Bhuvan", "Hello", "Bye", "Name", "Boaty", "McBoatface", "Trent", "Cook", "Danny", "Keven", "Edyth", "Keenn", "Keenan", "Florrie", "Rachele", "Steinhauer", "Mariella", "Favvreau" };
int keynum = 26;
int reqnum = 4;
...
// for(int i=0; i < 6; i++){
  clock_t t;
  t = clock();
  char *req = (char *) malloc(120);
  char *keyyy = (char *)malloc(10);
  sprintf(req, "%s %s %s", requests[rand() % reqnum], rand_string(keyyy, 9), keysvals[rand() % keynum]); 
